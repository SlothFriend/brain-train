export default {
  ...
  GENERATION_JUMP: 1000,
  MAX_PROCESSING_MS: 1000,
  NEURON_ADD_SUB_CHANCE: .02,
  NEURON_ADD_SUB_CHANCE_TO_ADD: .6, // If we need to add/sub a neuron, how likely is it an add instead of a subtract?
}
